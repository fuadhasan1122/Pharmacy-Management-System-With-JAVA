    ...
    public static void main(String[] args) {
        try {
         ...
         //st.executeUpdate("Insert into appuser(userRole, name, dob, mobileNumber, email, username, password, address) values('Admin', 'Admin', '15-11-2001', '01708015296', 'admin@gmail.com', 'admin', 'admin', 'Sylhet')");
          // Create medicine table with medicine_pk as auto-increment primary key
st.executeUpdate("create table medicine(medicine_pk int AUTO_INCREMENT primary key, uniqueId varchar(200), type_of_medicines varchar(200), name varchar(200), companyName varchar(200), quantity bigint, price bigint)");
